...
public class LineComparisonUC2 {
	...
	public static void main(String[] args) {
		...
		LineComparisonUC2 line = new LineComparisonUC2();
		line.checkEqual(ax1, ax2, ay1, ay2, bx1, by1, bx2, by2);
		sc.close();
	}

	public void checkEqual(double ax1, double ax2, double ay1, double ay2, double bx1, double by1, double bx2,
			double by2) {
		String lengthofline1 = String
				.valueOf(Math.floor(Math.sqrt(((ax2 - ax1) * (ax2 - ax1)) + ((ay2 - ay1) * (ay2 - ay1)))));
		String lengthofline2 = String
				.valueOf(Math.floor(Math.sqrt(((bx2 - bx1) * (bx2 - bx1)) + ((by2 - by1) * (by2 - by1)))));
